...
contract SharkRise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x70ffad80FF863E09D5e552F8a3EE472dc408B2F4); // Marketing Address
    ...
    string private _name = "SharkRise";
